...
package org.prebid.mobile.microsoft.rendering.networking.modelcontrollers;
...
import org.prebid.mobile.microsoft.rendering.networking.parameters.AdRequestInput;
import org.prebid.mobile.microsoft.rendering.networking.parameters.AppInfoParameterBuilder;
import org.prebid.mobile.microsoft.rendering.networking.parameters.BasicParameterBuilder;
import org.prebid.mobile.microsoft.rendering.networking.parameters.DeviceInfoParameterBuilder;
import org.prebid.mobile.microsoft.rendering.networking.parameters.GeoLocationParameterBuilder;
import org.prebid.mobile.microsoft.rendering.networking.parameters.NetworkParameterBuilder;
import org.prebid.mobile.microsoft.rendering.networking.parameters.ParameterBuilder;
import org.prebid.mobile.microsoft.rendering.networking.parameters.UserConsentParameterBuilder;
import org.prebid.mobile.microsoft.rendering.networking.parameters.UserParameters;
import org.prebid.mobile.microsoft.rendering.networking.urlBuilder.PathBuilderBase;
import org.prebid.mobile.microsoft.rendering.networking.urlBuilder.URLBuilder;
import org.prebid.mobile.microsoft.rendering.networking.urlBuilder.URLComponents;
...
import org.prebid.mobile.microsoft.rendering.sdk.deviceData.managers.ConnectionInfoManager;
import org.prebid.mobile.microsoft.rendering.sdk.deviceData.managers.DeviceInfoManager;
