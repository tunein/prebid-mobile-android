...
package org.prebid.mobile.microsoft.rendering.parser;
...
import org.prebid.mobile.microsoft.rendering.errors.VastParseError;
import org.prebid.mobile.microsoft.rendering.networking.parameters.BasicParameterBuilder;
import org.prebid.mobile.microsoft.rendering.utils.helpers.Utils;
import org.prebid.mobile.microsoft.rendering.video.VideoAdEvent;
import org.prebid.mobile.microsoft.rendering.video.vast.Ad;
import org.prebid.mobile.microsoft.rendering.video.vast.AdVerifications;
import org.prebid.mobile.microsoft.rendering.video.vast.ClickTracking;
import org.prebid.mobile.microsoft.rendering.video.vast.Companion;
import org.prebid.mobile.microsoft.rendering.video.vast.Creative;
import org.prebid.mobile.microsoft.rendering.video.vast.Extension;
import org.prebid.mobile.microsoft.rendering.video.vast.Impression;
import org.prebid.mobile.microsoft.rendering.video.vast.InLine;
import org.prebid.mobile.microsoft.rendering.video.vast.MediaFile;
import org.prebid.mobile.microsoft.rendering.video.vast.VAST;
...
public class AdResponseParserVast extends AdResponseParserBase {
    ...
    private ArrayList<org.prebid.mobile.microsoft.rendering.video.vast.Tracking> trackings;
    private ArrayList<ClickTracking> clickTrackings;
    private ArrayList<Impression> impressions;

    private VAST vast;

    public ArrayList<org.prebid.mobile.microsoft.rendering.video.vast.Tracking> getTrackings() {
        return trackings;
    }
    ...
    public ArrayList<org.prebid.mobile.microsoft.rendering.video.vast.Tracking> getTrackingEvents(VAST vast, int index) {
    ...
    public ArrayList<org.prebid.mobile.microsoft.rendering.video.vast.Tracking> getAllTrackings(AdResponseParserVast parserVast, int index) {
    ...
    public ArrayList<String> getTrackingByType(VideoAdEvent.Event event) {
        Iterator<org.prebid.mobile.microsoft.rendering.video.vast.Tracking> iterator = trackings.iterator();

        ArrayList<String> urls = new ArrayList<>();

        while (iterator.hasNext()) {
            org.prebid.mobile.microsoft.rendering.video.vast.Tracking t = iterator.next();
     ...
     */
    public static org.prebid.mobile.microsoft.rendering.video.vast.Tracking findTracking(ArrayList<org.prebid.mobile.microsoft.rendering.video.vast.Tracking> trackingEvents) {
        if (trackingEvents != null) {
            for (org.prebid.mobile.microsoft.rendering.video.vast.Tracking tracking : trackingEvents) {
