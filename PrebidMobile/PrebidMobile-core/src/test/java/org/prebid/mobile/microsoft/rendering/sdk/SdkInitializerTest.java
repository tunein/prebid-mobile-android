...
import org.prebid.mobile.microsoft.reflection.sdk.PrebidMobileReflection;
...
public class SdkInitializerTest {
    ...
    public void runBackgroundTasks_checkStartedTasks() throws InterruptedException {
        ...
        MatcherAssert.assertThat(requesterClassName, is(startsWith("class org.prebid.mobile.microsoft.rendering.sdk.StatusRequester")));
        ...
        MatcherAssert.assertThat(firstTaskName, is(startsWith("class org.prebid.mobile.microsoft.rendering.sdk.SdkInitializer$UserConsentFetcherTask")));

        String secondTaskName = allTasks.get(1).getClass().toString();
        MatcherAssert.assertThat(secondTaskName, is(startsWith("class org.prebid.mobile.microsoft.rendering.sdk.UserAgentFetcherTask")));
