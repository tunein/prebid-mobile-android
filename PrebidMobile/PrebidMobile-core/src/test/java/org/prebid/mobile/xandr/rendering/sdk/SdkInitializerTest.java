...
import static org.prebid.mobile.xandr.api.rendering.pluginrenderer.PrebidMobilePluginRegister.PREBID_MOBILE_RENDERER_NAME;
...
import org.prebid.mobile.xandr.reflection.sdk.PrebidMobileReflection;
...
public class SdkInitializerTest {
    ...
    public void runBackgroundTasks_checkStartedTasks() throws InterruptedException {
        ...
        MatcherAssert.assertThat(requesterClassName, is(startsWith("class org.prebid.mobile.xandr.rendering.sdk.StatusRequester")));
        ...
        MatcherAssert.assertThat(firstTaskName, is(startsWith("class org.prebid.mobile.xandr.rendering.sdk.SdkInitializer$UserConsentFetcherTask")));

        String secondTaskName = allTasks.get(1).getClass().toString();
        MatcherAssert.assertThat(secondTaskName, is(startsWith("class org.prebid.mobile.xandr.rendering.sdk.UserAgentFetcherTask")));
